...
slug: engineering-reading-list
date: 15 April, 25
---

Here’s a curated list of websites, blogs and articles worth keeping an eye on for their innovation, utility, or overall impact. This list will evolve over time as I discover more.

## Blogs and articles
- [Javascript event loop](https://www.lydiahallie.com/blog/event-loop)
- [Rate limiting in Node.js](https://blog.logrocket.com/rate-limiting-node-js/)

## Websites
- [CNCF Landscape](https://landscape.cncf.io/)
- [Zerodha's Tech Blog](https://zerodha.tech/blog/)
...
- [Things they didn't teach you in tech](https://vadimkravcenko.com/shorts/things-they-didnt-teach-you/)
